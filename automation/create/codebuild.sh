...
aws cloudformation create-stack \
    ...
    --parameters \
        ...
        ParameterKey=ServerBuildSpecFilePath,ParameterValue=$SERVER_BUILDSPEC_FILEPATH \
        ParameterKey=ClientBuildSpecFilePath,ParameterValue=$CLIENT_BUILDSPEC_FILEPATH \
